...
uint8_t putbuff_USART1[PUTBUFFS_USART1];
uint16_t gettop_USART1;
uint16_t getend_USART1;
uint16_t getall_USART1;
uint8_t getbuff_USART1[GETBUFFS_USART1];
#endif
...
uint8_t putbuff_USART2[PUTBUFFS_USART2];
uint16_t gettop_USART2;
uint16_t getend_USART2;
uint16_t getall_USART2;
uint8_t getbuff_USART2[GETBUFFS_USART2];
#endif
...
uint8_t putbuff_USART3[PUTBUFFS_USART3];
uint16_t gettop_USART3;
uint16_t getend_USART3;
uint16_t getall_USART3;
uint8_t getbuff_USART3[GETBUFFS_USART3];
#endif
...
void Clearput_USART1(void)
{
	...
	for(teep = 0; teep < PUTBUFFS_USART1; teep++)
		putbuff_USART1[teep] = 0;
}

uint16_t Checkput_USART1(void)
{
	return (PUTBUFFS_USART1-putall_USART1);	
}
...
ErrorStatus Put_USART1(uint8_t data)
{
	...
	if( putall_USART1 < PUTBUFFS_USART1) 
	{
		putbuff_USART1[ puttop_USART1] = data;
		putall_USART1++;
		if( puttop_USART1 < ( PUTBUFFS_USART1 - 1)) puttop_USART1++;
...
void Clearget_USART1(void)
{
	...
	for(teep = 0; teep < GETBUFFS_USART1; teep++)
...
uint8_t Get_USART1(void)
{
	...
	if( getall_USART1 > 0) 
	{
		...
		getall_USART1--;
		if(getend_USART1 < ( GETBUFFS_USART1 - 1)) getend_USART1++;
...
ErrorStatus printf_USART1(char* string)
{
	...
	if(0xff > number_teep)
	if((PUTBUFFS_USART1-putall_USART1) >= number_teep)
	{
		string_teep = string;
...
void Clearput_USART2(void)
{
	...
	for(teep = 0; teep < PUTBUFFS_USART2; teep++)
		putbuff_USART2[teep] = 0;
}

uint16_t Checkput_USART2(void)
{
	return (PUTBUFFS_USART2-putall_USART2);	
}
...
ErrorStatus Put_USART2(uint8_t data)
{
	...
	if( putall_USART2 < PUTBUFFS_USART2) 
	{
		putbuff_USART2[ puttop_USART2] = data;
		putall_USART2++;
		if( puttop_USART2 < ( PUTBUFFS_USART2 - 1)) puttop_USART2++;
...
void Clearget_USART2(void)
{
	...
	for(teep = 0; teep < GETBUFFS_USART2; teep++)
...
uint8_t Get_USART2(void)
{
	...
	if( getall_USART2 > 0) 
	{
		...
		getall_USART2--;
		if(getend_USART2 < ( GETBUFFS_USART2 - 1)) getend_USART2++;
...
ErrorStatus printf_USART2(char* string)
{
	...
	if(0xff > number_teep)
	if((PUTBUFFS_USART2-putall_USART2) >= number_teep)
	{
		string_teep = string;
...
void Clearput_USART3(void)
{
	...
	for(teep = 0; teep < PUTBUFFS_USART3; teep++)
		putbuff_USART3[teep] = 0;
}

uint16_t Checkput_USART3(void)
{
	return (PUTBUFFS_USART3-putall_USART3);	
}
...
ErrorStatus Put_USART3(uint8_t data)
{
	...
	if( putall_USART3 < PUTBUFFS_USART3) 
	{
		putbuff_USART3[ puttop_USART3] = data;
		putall_USART3++;
		if( puttop_USART3 < ( PUTBUFFS_USART3 - 1)) puttop_USART3++;
...
void Clearget_USART3(void)
{
	...
	for(teep = 0; teep < GETBUFFS_USART3; teep++)
...
uint8_t Get_USART3(void)
{
	...
	if( getall_USART3 > 0) 
	{
		...
		getall_USART3--;
		if(getend_USART3 < ( GETBUFFS_USART3 - 1)) getend_USART3++;
...
ErrorStatus printf_USART3(char* string)
{
	...
	if(0xff > number_teep)
	if((PUTBUFFS_USART3-putall_USART3) >= number_teep)
	{
		string_teep = string;
