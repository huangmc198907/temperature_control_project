...
//	CAN_FilterInitStruct.CAN_FilterActivation = DISABLE;
	...
	CAN1->sFilterRegister[0].FR2 = ((((APP_MOSI_CHANNEL<<5)|0x0000)<<16)|(((CODE_MOSI_CHANNEL<<5)|0x0000)&0x0000ffff));
	CAN1->sFilterRegister[1].FR1 = ((BROADCAST_CHANNEL<<5)|0x0000)&0x0000ffff;
	CAN1->FMR &= ~0x00000001;
